...
function eventHandler() {
	...
	var teamSlider = new Swiper('.team-slider-js', {
		slidesPerView: 'auto',
		loop: true,
		breakpoints: {
			0: {
	...
	var certificatSlider = new Swiper('.certificat-slider-js', {
		slidesPerView: 'auto',
		loop: true,
		breakpoints: {
			0: {
	...
	var allHead = document.querySelectorAll('.vac-head-js');

	var _iterator = _createForOfIteratorHelper(allHead),
			_step;
